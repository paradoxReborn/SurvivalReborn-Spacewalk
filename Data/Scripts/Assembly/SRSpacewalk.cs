...
///    the license is supplementd with the following additional terms:
...
namespace SurvivalReborn
{
    ...
    /// 
    /// KNOWN ISSUES:
    /// - The jetpack fuel level visually desyncs in multiplayer when the game tries (in vain) to refuel it.
    /// 
